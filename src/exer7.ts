...
function createListType(Worker: {name: string, age: number, occupation?: string,  commission?: number, wage?: number | string}): Worker {
...
const worker = createListType({ name: "Lucas", age: 40, commission: 3, wage: 7000 })
